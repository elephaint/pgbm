...
idx_pi_sup = np.argsort(mean_permutation_importance_supervised)
...
idx_pi_unsup = np.argsort(mean_permutation_importance_unsupervised)
#%% Plot both
fig, ax = plt.subplots(1, 3)
ax[0].barh(feature_names[idx_fi], model.feature_importance[idx_fi])
...
ax[1].boxplot(permutation_importance_supervised[idx_pi_sup].T, labels=feature_names[idx_pi_sup], vert=False)
...
ax[2].boxplot(permutation_importance_unsupervised[idx_pi_unsup].T, labels=feature_names[idx_pi_unsup], vert=False)
